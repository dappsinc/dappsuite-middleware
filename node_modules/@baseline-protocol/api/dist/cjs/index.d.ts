...
export declare const baselineProviderEthers = "ethers";
export declare const baselineProviderProvide = "provide";
export declare const baselineProviderRpc = "rpc";
...
export { MerkleTreeNode };
export declare function baselineServiceFactory(provider: string, config?: any): Promise<IBaselineRPC & IBlockchainService & IRegistry & IVault>;
