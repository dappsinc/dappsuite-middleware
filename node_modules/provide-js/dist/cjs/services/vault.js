...
class Vault {
    ...
    seal(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return clients_1.ApiClient.handleResponse(yield this.client.post('seal', { key: key }));
        });
    }
    unseal(key) {
        return __awaiter(this, void 0, void 0, function* () {
            return clients_1.ApiClient.handleResponse(yield this.client.post('unseal', { key: key }));
        });
    }
}
exports.Vault = Vault;
