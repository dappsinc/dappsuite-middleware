...
var enabledNetworksByService = {
  ...
  lendingPool: (_lendingPool = {}, _lendingPool[Market.Proto] = [Network.kovan, Network.mainnet, Network.polygon], _lendingPool[Market.AMM] = [Network.kovan, Network.mainnet], _lendingPool),
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 21:
              ...
              convertedAmountNoFees = BigNumber$1.from(convertedAmount).sub(BigNumber$1.from(convertedAmount).mul(FLASHLOAN_PREMIUM_TOTAL).div(10000)).toString();
              ...
              params = utils.defaultAbiCoder.encode(['address[]', 'uint256[]', 'bool[]', 'uint256[]', 'uint256[]', 'uint8[]', 'bytes32[]', 'bytes32[]', 'bool[]'], [[toAsset], [amountSlippageConverted], [swapAll], [permitParams.amount], [permitParams.deadline], [permitParams.v], [permitParams.r], [permitParams.s], [useEthPath || false]]);
              txCallback = this.generateTxCallback({
                rawTxMethod: function rawTxMethod() {
            ...
            case 29:
              ...
              return this.liquiditySwapAdapterService.swapAndDeposit({
                ...
                amountToSwap: swapAll ? constants.MaxUint256.toString() : convertedAmount,
